...
export dir_xml_jacoco=$dir_base/out-jacoco/report-jacoco-chart.xml
export dir_m2=/root/.m2/repository/
export dir_epc_tool=$dir_base/PPgSI/edge-pair-cov-tool/epc-tool-cli/target/epc-tool-cli-0.0.1-SNAPSHOT-all.jar
export dir_destino_epc_tool=$dir_base/out-epc-tool
export dir_xml_epc_tool=$dir_base/out-epc-tool/report-chart
...
export classpath="$dir_m2/org/eclipse/swt/org.eclipse.swt.win32.win32.x86_64/4.3/org.eclipse.swt.win32.win32.x86_64-4.3.jar;$dir_m2/org/jfree/jfreechart/1.5.0/jfreechart-1.5.0.jar;$dir_fonte/lib/iText-2.1.4.jar;$dir_fonte/lib/junit.jar;$dir_fonte/lib/servlet.jar"
rm ./jacoco.exec
rm ./coverage.ser
...
{ time java -jar $dir_jacoco report ./jacoco.exec --classfiles $dir_destino_jacoco/build --classfiles $dir_destino_jacoco/build-tests --xml $dir_xml_jacoco; } 2>> $dir_base/output-chart.txt
